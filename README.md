...
A static, GitHub Pages–ready portfolio site: product management case studies.
No build step, no framework — just HTML/CSS/JS.

## Structure

```
index.html                     Home page (About, Case Studies grid, Contact)
styles.css                     All styling (colors, layout, animations)
script.js                      Nav, scroll-reveal, back-to-top
case-studies/
  uber-eats.html
  depop.html
  framer.html
